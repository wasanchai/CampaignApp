...
export default class CampaignReportCtrl extends Controller {
  constructor() {
    super(...arguments);
   ...
   // alert(this.CampaignID);
    ...
    this.labels = ["01/04", "02/04", "02/04", "03/04", "03/04", "03/04", "04/04", "05/04", "06/04"];
...
CampaignReportCtrl.$inject = ['$scope', '$stateParams', '$ionicActionSheet','$state','$timeout', '$ionicScrollDelegate','$ionicPopup'];
